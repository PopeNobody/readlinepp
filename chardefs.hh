...
#define control_character_threshold                                       \
  0x020                                /* Smaller than this is control. */
...
#define META_CHAR(c)                                                      \
  ((c) > meta_character_threshold && (c) <= largest_char)
...
#ifndef _rl_to_upper
#define _rl_to_upper(c)                                                   \
  (_rl_lowercase_p(c) ? toupper((unsigned char)c) : (c))
#define _rl_to_lower(c)                                                   \
  (_rl_uppercase_p(c) ? tolower((unsigned char)c) : (c))
#endif
