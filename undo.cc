/* undo.c - manage list of changes to lines, offering opportunity to undo
 * them */
...
extern void _hs_replace_history_data PARAMS((int,
                                             histdata_t*,
                                             histdata_t*));
...
UNDO_LIST* _rl_copy_undo_entry(UNDO_LIST* entry)
{
  ...
  _new= alloc_undo_entry(
           entry->what, entry->start, entry->end, (char*)NULL);
...
#define TRANS(i) ((i) == -1 ? rl_point : ((i) == -2 ? rl_end : (i)))
 ...
 rl_point, and a value of -2 means rl_end. */
    if (rl_undo_list->what == UNDO_DELETE ||
 ...
 replicated in the history entry's line */
    cur= current_history();
    ...
    _hs_replace_history_data(
             -1, (histdata_t*)release, (histdata_t*)rl_undo_list);
