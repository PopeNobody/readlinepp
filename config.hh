...
/* Define to 1 if you have the declaration of `AUDIT_USER_TTY', and to 0 if
   you don't. */
...
/* Define to 1 if you have the `mbschr' function. */
/* #undef HAVE_MBSCHR */
...
/* Define to 1 if you have the <mbstr.h> header file. */
/* #undef HAVE_MBSTR_H */
...
#define PACKAGE_STRING "readline 8.0"
