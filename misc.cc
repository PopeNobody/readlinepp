...
/* Get the previous item out of our interactive history, making it the
   current line.  If there is no previous history, just ding. */
...
/* Function for the rest of the library to use to set insert/overwrite
 * mode. */
