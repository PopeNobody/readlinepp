...
static int main_loop(void)
{
  ...
  for (;;)
  {
     ...
     * Wrote to masterfd, slave fd has that input, alert readline to read
     * it.
     */
...
/* tty_cbreak: Sets terminal to cbreak mode. Also known as noncanonical
 * mode.
 *    1. Signal handling is still turned on, so the user can still type
 * those.
 *    2. echo is off
